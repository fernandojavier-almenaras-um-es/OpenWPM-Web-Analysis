...
from utils.analyzers_utils import all_analyzers_strings
...
if __name__ == '__main__':
    ...
    analyses : List[str] = args.analyzers_names if args.analyzers_names[0] != "all" else all_analyzers_strings()
