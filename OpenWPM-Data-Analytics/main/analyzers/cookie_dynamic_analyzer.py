    ...
    def analyser_query(self) -> CursorResult[Any]:
        with SingletonEngine.get_engine().connect() as conn:
            return conn.execute(text(f"""
                SELECT JAVASCRIPT_COOKIES.visit_id, JAVASCRIPT_COOKIES.host AS script_url, JAVASCRIPT.top_level_url, JAVASCRIPT_COOKIES.name,
                        JAVASCRIPT_COOKIES.is_host_only, JAVASCRIPT_COOKIES.is_http_only, JAVASCRIPT_COOKIES.is_secure, JAVASCRIPT_COOKIES.is_session
