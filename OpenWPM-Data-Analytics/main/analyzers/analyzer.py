...
class Analyzer(ABC):
    ...
    def analyser_query(self) -> CursorResult[Any]:
        """
        return a common query used during the analysis
        """
        pass

    def __init__(self, db : Any, logger : logging.Logger) -> None:
        """
        Initialize the analyzer
        """
        self.engine: Engine = SingletonEngine.get_engine()
        self.db: Any = db
        self.logger: logging.Logger = logger
        self.results : None | List[ Tuple[str,str,str,int] ] = None
    ...
    def get_analysis_results(self) -> List[ Tuple[str,str,str,int] ]:
        """
    ...
    def set_analysis_results(self, results: List[ Tuple[str,str,str,int] ]) -> None:
        """
