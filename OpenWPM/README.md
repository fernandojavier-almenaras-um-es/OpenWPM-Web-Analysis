...
This is a fork of the commit [f74e79fca69f8824ffd1c69f1b349890e97b4217](https://github.com/openwpm/OpenWPM/tree/f74e79fca69f8824ffd1c69f1b349890e97b4217).
The custom script is found in [`script.py`](script.py) and more objects, functions and properties had been added to [`fingerprinting.json`](openwpm/js_instrumentation_collections/fingerprinting.json). You could see the changes with `git diff`, after overwriting a copy of the commit forked.
